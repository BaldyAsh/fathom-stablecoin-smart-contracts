...
const openPositionAndDraw = async (proxyWallet, collateral_pool_id, stablecoinAmount) => {
  ...
  const openPositionCall = openLockTokenAndDrawIFace.encodeFunctionData("openLockXDCAndDraw", [
    ...
    "0x49432EabefB665d0e0DFb7AE814b93E84797DC3C", // StabilityFeeCollector
  ...
  const tx = await proxyWallet.execute(openPositionCall, { value: ethers.constants.WeiPerEther.mul(50000), gasLimit: 2000000})
...
module.exports = async function(deployer) {
  ...
  let proxyWalletapothemDeployerTest = "0x68eE1cb14c90cd94F6DdeCD36f1D8E6A754de729";
  ...
  // for (let i = 0; i < (26-5); i++) {
    ...
    await openPositionAndDraw(proxyWalletAsAlice, COLLATERAL_POOL_ID, WeiPerWad.mul(100));
