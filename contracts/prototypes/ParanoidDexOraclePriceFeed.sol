...
import "../main/interfaces/IFathomOraclePriceFeed.sol";
import "../main/interfaces/IFathomOracle.sol";
import "../main/interfaces/IAccessControlConfig.sol";

contract ParanoidDexOraclePriceFeed is PausableUpgradeable, IFathomOraclePriceFeed {
    ...
    function initialize(address _fathomOracle, address[] calldata _verificationFeeds, address _token0, address _token1, address _accessControlConfig, bytes32 _poolId) external initializer {
    ...
    function readPrice() external view override returns (bytes32) {
        return bytes32(delayedPrice.price);
    }
    ...
    function _peekPrice() internal returns (bytes32, bool) {
        ...
        return (bytes32(delayedPrice.price), _isPriceOk());
    }
